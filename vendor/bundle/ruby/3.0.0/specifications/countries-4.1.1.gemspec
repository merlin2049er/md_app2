...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "http://github.com/countries/countries/issues", "changelog_uri" => "https://github.com/countries/countries/blob/master/CHANGELOG.md", "source_code_uri" => "https://github.com/countries/countries", "wiki_uri" => "https://github.com/countries/countries/wiki" } if s.respond_to? :metadata=
  ...
  s.homepage = "http://github.com/countries/countries".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<i18n_data>.freeze, ["~> 0.13.1"])
    ...
    s.add_dependency(%q<i18n_data>.freeze, ["~> 0.13.1"])
