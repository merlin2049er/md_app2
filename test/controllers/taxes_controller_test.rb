...
class TaxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tax" do
    assert_difference('Tax.count') do
      post taxes_url, params: { tax: { comment: @tax.comment, enabled: @tax.enabled, prov_id: @tax.prov_id, tax_rate: @tax.tax_rate } }
    end
  ...
  test "should update tax" do
    patch tax_url(@tax), params: { tax: { comment: @tax.comment, enabled: @tax.enabled, prov_id: @tax.prov_id, tax_rate: @tax.tax_rate } }
