...
ActiveRecord::Schema.define(version: 2021_11_16_174456) do
  ...
  create_table "search_fors", force: :cascade do |t|
    t.string "searchterm"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  create_table "voteds", force: :cascade do |t|
    t.integer "user_id"
    t.integer "poll_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "polloption_id"
  end
